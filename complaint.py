...
from documents import (witness_report, silipsi, deltio_kat, apologia, rights, vas, transmission,
                       ...
                       transmission_adjudication, complaint_report,
                       context)
from lawwindow import GunLaw
import os
import sys


class Complaint(QWidget):
    def __init__(self, parent_window=None):
        super().__init__()
        self.parent_window = parent_window
        self.setWindowTitle("Μήνυση Ιδιώτη")
        ...
        options=[
                "1. Μήνυση Ιδιώτη εκτός αυτοφώρου",
                "2. Μήνυση Ιδιώτη  αυτόφωρο",
                "3. ← Πίσω"
                ]
        ...
        for option in options:
            ...
            if option == "1. Μήνυση Ιδιώτη εκτός αυτοφώρου":
                button.clicked.connect(self.open_case_1)
            elif option == "2. Μήνυση Ιδιώτη  αυτόφωρο":
