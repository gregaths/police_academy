...
from lawwindow import ObligationLaw
import sys
import os


class Obligation(QWidget):
    def __init__(self, parent_window=None):
        super().__init__()
        self.parent_window=parent_window
        self.setWindowTitle("Μήνυση για Παραβίαση Υποχρέωσης Διατροφής")
        ...
        options=[
            "1. Μήνυση για παραβίαση διατροφής",
            "2. Μήνυση με γνωστό δράστη και σύλληψη",
            "3. Άρθρο 358 του Π.Κ - Ανάλυση",
            "4. ← Πίσω"
        ]
        ...
        for option in options:
            ...
            if option == "1. Μήνυση για παραβίαση διατροφής":
            ...
            elif option == "3. Άρθρο 358 του Π.Κ - Ανάλυση":
    ...
    def open_case_3a(self):
        self.case_3a_window = ObligationLaw()
...
class Case1Window(QWidget):
    def __init__(self):
        ...
        fields=[
            ...
            ("obligation", "Τι προέβλεπε και παραβιάστηκε στην απόφαση"),
