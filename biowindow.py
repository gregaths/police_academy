    ...
    def __init__(self):
        ...
        <body>
            ...
            τάχιστη περαίωση των αυτοφώρων και μηνύσεων με σκοπό την εξοικονομηση χρόνου.</p> 
             ...
             <p align="justify"><strong>Γενικές Οδηγίες</strong> 
             <ol>
             <li style="color:blue;">Τα εγγραφα δημιουργούνται μόλις πατήσει ο χρήστης το κουμπί δημιουργία εγγράφων σε 
             word αρχεία. Συνίσταται στον χρήστη να κάνει ενδελεχή έλεγχο πριν την εκτυπωση τους.</li>
